			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">						
						...
						{{ image("img/2.jpg", "alt": "", "class":"img-responsive") }}
		...
		<div class="container">		
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					{{ image("img/8.jpg", "alt": "", "class":"img-responsive") }}
					<figcaption>
						<h4>sweet marley</h4>
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					{{ image("img/9.jpg", "alt": "", "class":"img-responsive") }}
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					{{ image("img/10.jpg", "alt": "", "class":"img-responsive") }}
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
		...
		<div class="container">
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					{{ image("img/11.jpg", "alt": "", "class":"img-responsive") }}
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					{{ image("img/12.jpg", "alt": "", "class":"img-responsive") }}
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
			...
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					{{ image("img/13.jpg", "alt": "", "class":"img-responsive") }}
					<figcaption>
						<h4>sweet marley</h4>
						<p>Marley tried to convince her but she was not interested.</p>				
					</figcaption>			
